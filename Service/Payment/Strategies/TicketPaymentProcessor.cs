...
public class TicketPaymentProcessor : ApplicationService, IPaymentProcessor
{
    private readonly IRequestService _requestService;

    public TicketPaymentProcessor(IRequestService requestService, IApplicationNotificationHandler notifications) : base(notifications)
    {
    ...
    public async Task<ResponseBaseDto> Process(MakePaymentDto dto)
    {
        ...
        return ResponseBaseDto.Ok("Pedido Pago Com Sucesso(boleto)");
    }
}